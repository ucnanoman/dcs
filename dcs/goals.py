...
class AllOfCoalitionInZone(GoalRule):
...
class AllOfCoalitionOutsideZone(GoalRule):
...
class AllOfGroupInZone(GoalRule):
...
class AllOfGroupOutsideZone(GoalRule):
...
class ArgumentInRange(GoalRule):
...
class CargoUnhookedInZone(GoalRule):
...
class CoalitionHasAirdrome(GoalRule):
...
class CoalitionHasHelipad(GoalRule):
...
class CockpitHighlightVisible(GoalRule):
...
class CockpitParamEqual(GoalRule):
...
class CockpitParamEqualToAnother(GoalRule):
...
class CockpitParamInRange(GoalRule):
...
class FlagIsLessThanFlag(GoalRule):
...
class IndicationTextEqual(GoalRule):
...
class MissionScoreHigher(GoalRule):
...
class MissionScoreLower(GoalRule):
...
class PartOfCoalitionInZone(GoalRule):
...
class PartOfCoalitionOutsideZone(GoalRule):
...
class PartOfGroupInZone(GoalRule):
...
class PartOfGroupOutsideZone(GoalRule):
...
class PlayerScoreLess(GoalRule):
...
class PlayerScoreMore(GoalRule):
...
class SignalFlareInZone(GoalRule):
...
class UnitAltitudeHigher(GoalRule):
...
class UnitHeadingWithin(GoalRule):
...
class UnitInMovingZone(GoalRule):
...
class UnitOutsideMovingZone(GoalRule):
...
class UnitOutsideZone(GoalRule):
...
class UnitPitchWithin(GoalRule):
...
class UnitSpeedHigher(GoalRule):
...
class UnitVerticalSpeedWithin(GoalRule):
...
class Goal:
    ...
    def load_from_dict(self, data):
        ...
        rules = data["rules"]
        for x in rules:
            gr = Goal.goalrule_map[rules[x]["predicate"]].create_from_dict(rules[x])
