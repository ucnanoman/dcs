...
class Caucasus(Terrain):
    ...
    def __init__(self):
        ...
        anapa.unit_zones.append(mapping.Rectangle(-5802.857142854, 242768.57142857, -7402.857142854, 244368.57142857))
        anapa.unit_zones.append(mapping.Rectangle(-4217.1428571397, 239325.71428572, -5417.1428571397, 240525.71428572))
        anapa.unit_zones.append(mapping.Rectangle(-5759.9999999969, 239132.85714286, -7159.9999999969, 240532.85714286))
        anapa.unit_zones.append(mapping.Rectangle(-3967.1428571397, 245318.57142857, -6767.1428571397, 248118.57142857))
        self.airports[anapa.name] = anapa

        krasnodar_center = Airport(13, "Krasnodar-Center", 122.0, 11692.789495652, 367948.47230953, None)
        krasnodar_center.runways.append(Runway(270))
        krasnodar_center.runways.append(Runway(90))
        krasnodar_center.parking_slots[3] = ParkingSlot(3, 11250.362304688, 369029.71875, large=False, slot_name="33", heli=False)
        krasnodar_center.parking_slots[4] = ParkingSlot(4, 11209.124023438, 369103.96875, large=False, slot_name="34", heli=False)
        krasnodar_center.parking_slots[5] = ParkingSlot(5, 11297.9140625, 369131.84375, large=False, slot_name="35", heli=False)
        krasnodar_center.parking_slots[8] = ParkingSlot(8, 11354.944335938, 369350.1875, large=False, slot_name="30", heli=False)
        krasnodar_center.parking_slots[9] = ParkingSlot(9, 11279.916992188, 369310.375, large=False, slot_name="31", heli=False)
        krasnodar_center.parking_slots[10] = ParkingSlot(10, 11339.193359375, 369238.625, large=False, slot_name="32", heli=False)
        krasnodar_center.parking_slots[13] = ParkingSlot(13, 11479.546875, 369366.09375, large=False, slot_name="27", heli=False)
        krasnodar_center.parking_slots[14] = ParkingSlot(14, 11430.643554688, 369296.625, large=False, slot_name="28", heli=False)
        krasnodar_center.parking_slots[15] = ParkingSlot(15, 11515.967773438, 369259.5, large=False, slot_name="29", heli=False)
        krasnodar_center.parking_slots[18] = ParkingSlot(18, 11554.1015625, 369290.15625, large=False, slot_name="25", heli=False)
        krasnodar_center.parking_slots[20] = ParkingSlot(20, 11603.004882813, 369359.625, large=False, slot_name="24", heli=False)
        krasnodar_center.parking_slots[21] = ParkingSlot(21, 11639.42578125, 369253.03125, large=False, slot_name="26", heli=False)
        krasnodar_center.parking_slots[24] = ParkingSlot(24, 11539.911132813, 369555.09375, large=False, slot_name="40", heli=False)
        krasnodar_center.parking_slots[27] = ParkingSlot(27, 11644.665039063, 369477.75, large=False, slot_name="37", heli=False)
        krasnodar_center.parking_slots[28] = ParkingSlot(28, 11693.568359375, 369547.21875, large=False, slot_name="36", heli=False)
        krasnodar_center.parking_slots[29] = ParkingSlot(29, 11608.244140625, 369584.34375, large=False, slot_name="38", heli=False)
        krasnodar_center.parking_slots[32] = ParkingSlot(32, 11454.586914063, 369592.21875, large=False, slot_name="41", heli=False)
        krasnodar_center.parking_slots[33] = ParkingSlot(33, 11491.0078125, 369485.625, large=False, slot_name="39", heli=False)
        krasnodar_center.parking_slots[37] = ParkingSlot(37, 11188.311523438, 368984.75, large=False, slot_name="42", heli=False)
        krasnodar_center.parking_slots[39] = ParkingSlot(39, 11103.43359375, 368981.5, large=False, slot_name="43", heli=False)
        krasnodar_center.parking_slots[40] = ParkingSlot(40, 11118.734375, 369073.375, large=False, slot_name="44", heli=False)
        krasnodar_center.parking_slots[43] = ParkingSlot(43, 11117.921875, 368861.4375, large=False, slot_name="45", heli=False)
        krasnodar_center.parking_slots[45] = ParkingSlot(45, 11033.043945313, 368858.1875, large=False, slot_name="46", heli=False)
        krasnodar_center.parking_slots[46] = ParkingSlot(46, 11048.344726563, 368950.0625, large=False, slot_name="47", heli=False)
        krasnodar_center.parking_slots[49] = ParkingSlot(49, 11046.443359375, 368735.875, large=False, slot_name="48", heli=False)
        krasnodar_center.parking_slots[51] = ParkingSlot(51, 10961.565429688, 368732.625, large=False, slot_name="49", heli=False)
        krasnodar_center.parking_slots[52] = ParkingSlot(52, 10976.866210938, 368824.5, large=False, slot_name="50", heli=False)
        krasnodar_center.parking_slots[55] = ParkingSlot(55, 10973.875, 368608.53125, large=False, slot_name="51", heli=False)
        krasnodar_center.parking_slots[57] = ParkingSlot(57, 10888.997070313, 368605.28125, large=False, slot_name="52", heli=False)
        krasnodar_center.parking_slots[58] = ParkingSlot(58, 10904.297851563, 368697.15625, large=False, slot_name="53", heli=False)
        krasnodar_center.parking_slots[61] = ParkingSlot(61, 10900.069335938, 368479, large=False, slot_name="54", heli=False)
        krasnodar_center.parking_slots[63] = ParkingSlot(63, 10815.19140625, 368475.75, large=False, slot_name="55", heli=False)
        krasnodar_center.parking_slots[64] = ParkingSlot(64, 10830.4921875, 368567.625, large=False, slot_name="56", heli=False)
        krasnodar_center.parking_slots[99] = ParkingSlot(99, 11207.108398438, 367130.21875, large=False, slot_name="01", heli=True)
        krasnodar_center.parking_slots[100] = ParkingSlot(100, 11208.15625, 367150.15625, large=False, slot_name="02", heli=True)
        krasnodar_center.parking_slots[101] = ParkingSlot(101, 11209.203125, 367170.15625, large=False, slot_name="03", heli=True)
        krasnodar_center.parking_slots[102] = ParkingSlot(102, 11210.249023438, 367190.125, large=False, slot_name="04", heli=True)
        krasnodar_center.parking_slots[103] = ParkingSlot(103, 11211.295898438, 367210.09375, large=False, slot_name="05", heli=True)
        krasnodar_center.parking_slots[104] = ParkingSlot(104, 11212.342773438, 367230.0625, large=False, slot_name="06", heli=True)
        krasnodar_center.parking_slots[105] = ParkingSlot(105, 11213.389648438, 367250.03125, large=False, slot_name="07", heli=True)
        krasnodar_center.parking_slots[106] = ParkingSlot(106, 11214.436523438, 367270, large=False, slot_name="08", heli=True)
        krasnodar_center.parking_slots[107] = ParkingSlot(107, 11215.483398438, 367289.96875, large=False, slot_name="09", heli=True)
        krasnodar_center.parking_slots[108] = ParkingSlot(108, 11216.529296875, 367309.9375, large=False, slot_name="10", heli=True)
        krasnodar_center.parking_slots[109] = ParkingSlot(109, 11217.576171875, 367329.90625, large=False, slot_name="11", heli=True)
        krasnodar_center.parking_slots[110] = ParkingSlot(110, 11218.623046875, 367349.90625, large=False, slot_name="12", heli=True)
        krasnodar_center.parking_slots[111] = ParkingSlot(111, 11219.669921875, 367369.875, large=False, slot_name="13", heli=True)
        krasnodar_center.parking_slots[112] = ParkingSlot(112, 11220.716796875, 367389.84375, large=False, slot_name="14", heli=True)
        krasnodar_center.parking_slots[113] = ParkingSlot(113, 11221.763671875, 367409.8125, large=False, slot_name="15", heli=True)
        krasnodar_center.parking_slots[114] = ParkingSlot(114, 11222.809570313, 367429.78125, large=False, slot_name="16", heli=True)
        krasnodar_center.parking_slots[115] = ParkingSlot(115, 11223.856445313, 367449.75, large=False, slot_name="17", heli=True)
        krasnodar_center.parking_slots[116] = ParkingSlot(116, 11252.299804688, 368274.625, large=True, slot_name="18", heli=False)
        krasnodar_center.parking_slots[117] = ParkingSlot(117, 11255.440429688, 368334.53125, large=True, slot_name="19", heli=False)
        krasnodar_center.parking_slots[118] = ParkingSlot(118, 11258.581054688, 368394.4375, large=True, slot_name="20", heli=False)
        krasnodar_center.parking_slots[119] = ParkingSlot(119, 11261.720703125, 368454.34375, large=True, slot_name="21", heli=False)
        krasnodar_center.parking_slots[120] = ParkingSlot(120, 11264.861328125, 368514.28125, large=True, slot_name="22", heli=False)
        krasnodar_center.parking_slots[121] = ParkingSlot(121, 11268.000976563, 368574.1875, large=True, slot_name="23", heli=False)
        krasnodar_center.unit_zones.append(mapping.Rectangle(13360.857142856, 366714.28571429, 12360.857142856, 367714.28571429))
        krasnodar_center.unit_zones.append(mapping.Rectangle(13375.142857142, 367717.14285714, 12375.142857142, 368717.14285714))
        krasnodar_center.unit_zones.append(mapping.Rectangle(11072.285714285, 366687.14285714, 10372.285714285, 367387.14285714))
        krasnodar_center.unit_zones.append(mapping.Rectangle(15490.857142856, 361865.71428571, 12490.857142856, 364865.71428571))
        ...
        novorossiysk.unit_zones.append(mapping.Rectangle(-39022.285714285, 277836.85714285, -40122.285714285, 278936.85714285))
        novorossiysk.unit_zones.append(mapping.Rectangle(-40290.857142857, 279953.99999999, -40790.857142857, 280453.99999999))
        novorossiysk.unit_zones.append(mapping.Rectangle(-40255.142857142, 276589.71428571, -41155.142857142, 277489.71428571))
        self.airports[novorossiysk.name] = novorossiysk

        krymsk = Airport(15, "Krymsk", 124.0, -6583.663574989, 294383.98405512, None)
        krymsk.runways.append(Runway(220))
        krymsk.runways.append(Runway(40))
        krymsk.parking_slots[2] = ParkingSlot(2, -7523.8505859375, 293785.125, large=False, slot_name="04", heli=True)
        krymsk.parking_slots[4] = ParkingSlot(4, -7498.2939453125, 293754.34375, large=False, slot_name="02", heli=True)
        krymsk.parking_slots[6] = ParkingSlot(6, -7511.0883789063, 293769.75, large=False, slot_name="03", heli=True)
        krymsk.parking_slots[11] = ParkingSlot(11, -7536.615234375, 293800.5, large=False, slot_name="05", heli=True)
        krymsk.parking_slots[12] = ParkingSlot(12, -7549.3779296875, 293815.90625, large=False, slot_name="06", heli=True)
        krymsk.parking_slots[14] = ParkingSlot(14, -7562.1723632813, 293831.25, large=False, slot_name="07", heli=True)
        krymsk.parking_slots[16] = ParkingSlot(16, -7574.9345703125, 293846.65625, large=False, slot_name="08", heli=True)
        krymsk.parking_slots[19] = ParkingSlot(19, -5818.9565429688, 295246.28125, large=True, slot_name="55", heli=False)
        krymsk.parking_slots[21] = ParkingSlot(21, -5858.3950195313, 295291.5, large=True, slot_name="54", heli=False)
        krymsk.parking_slots[23] = ParkingSlot(23, -5779.55078125, 295201.0625, large=True, slot_name="56", heli=False)
        krymsk.parking_slots[25] = ParkingSlot(25, -5740.0849609375, 295155.875, large=True, slot_name="57", heli=False)
        krymsk.parking_slots[37] = ParkingSlot(37, -6101.1254882813, 295271.21875, large=False, slot_name="52", heli=False)
        krymsk.parking_slots[39] = ParkingSlot(39, -6146.380859375, 295188.65625, large=False, slot_name="53", heli=False)
        krymsk.parking_slots[62] = ParkingSlot(62, -6172.1333007813, 295287.09375, large=False, slot_name="51", heli=False)
        krymsk.parking_slots[65] = ParkingSlot(65, -8104.83203125, 293981.75, large=False, slot_name="16", heli=False)
        krymsk.parking_slots[66] = ParkingSlot(66, -8057.6416015625, 294061.9375, large=False, slot_name="18", heli=False)
        krymsk.parking_slots[67] = ParkingSlot(67, -8138.1328125, 294089.4375, large=False, slot_name="17", heli=False)
        krymsk.parking_slots[69] = ParkingSlot(69, -6536.3872070313, 295044.9375, large=False, slot_name="47", heli=False)
        krymsk.parking_slots[71] = ParkingSlot(71, -6462.9853515625, 295102.125, large=False, slot_name="46", heli=False)
        krymsk.parking_slots[72] = ParkingSlot(72, -6527.7041015625, 295157.34375, large=False, slot_name="45", heli=False)
        krymsk.parking_slots[75] = ParkingSlot(75, -6702.66796875, 294994.1875, large=False, slot_name="44", heli=False)
        krymsk.parking_slots[76] = ParkingSlot(76, -6629.2661132813, 295051.375, large=False, slot_name="43", heli=False)
        krymsk.parking_slots[77] = ParkingSlot(77, -6693.9848632813, 295106.59375, large=False, slot_name="42", heli=False)
        krymsk.parking_slots[80] = ParkingSlot(80, -7038.6762695313, 294746.28125, large=False, slot_name="41", heli=False)
        krymsk.parking_slots[81] = ParkingSlot(81, -6973.716796875, 294812.90625, large=False, slot_name="40", heli=False)
        krymsk.parking_slots[82] = ParkingSlot(82, -7045.3271484375, 294858.84375, large=False, slot_name="39", heli=False)
        krymsk.parking_slots[84] = ParkingSlot(84, -7485.5297851563, 293738.9375, large=False, slot_name="01", heli=True)
        krymsk.parking_slots[85] = ParkingSlot(85, -7187.0395507813, 294745.53125, large=True, slot_name="36", heli=False)
        krymsk.parking_slots[86] = ParkingSlot(86, -7270.5078125, 294703.71875, large=True, slot_name="35", heli=False)
        krymsk.parking_slots[87] = ParkingSlot(87, -7063.7890625, 294511.5625, large=True, slot_name="38", heli=False)
        krymsk.parking_slots[88] = ParkingSlot(88, -7171.9384765625, 294477.4375, large=True, slot_name="37", heli=False)
        krymsk.parking_slots[89] = ParkingSlot(89, -7322.7099609375, 294282.5625, large=True, slot_name="32", heli=False)
        krymsk.parking_slots[90] = ParkingSlot(90, -7402.568359375, 294233.5625, large=True, slot_name="30", heli=False)
        krymsk.parking_slots[91] = ParkingSlot(91, -7498.103515625, 294155.125, large=True, slot_name="29", heli=False)
        krymsk.parking_slots[92] = ParkingSlot(92, -7572.076171875, 294094.65625, large=True, slot_name="28", heli=False)
        krymsk.parking_slots[93] = ParkingSlot(93, -7627.1674804688, 294214.65625, large=True, slot_name="27", heli=False)
        krymsk.parking_slots[94] = ParkingSlot(94, -7601.8002929688, 294305.8125, large=True, slot_name="31", heli=False)
        krymsk.parking_slots[95] = ParkingSlot(95, -7511.4951171875, 294380.5625, large=True, slot_name="34", heli=False)
        krymsk.parking_slots[96] = ParkingSlot(96, -7420.8046875, 294397.375, large=True, slot_name="33", heli=False)
        krymsk.parking_slots[97] = ParkingSlot(97, -7744.3994140625, 293980.25, large=True, slot_name="12", heli=False)
        krymsk.parking_slots[98] = ParkingSlot(98, -7802.484375, 294050.40625, large=True, slot_name="13", heli=False)
        krymsk.parking_slots[99] = ParkingSlot(99, -7886.3530273438, 294252.53125, large=True, slot_name="20", heli=False)
        krymsk.parking_slots[100] = ParkingSlot(100, -8007.9438476563, 294150.03125, large=True, slot_name="19", heli=False)
        krymsk.parking_slots[101] = ParkingSlot(101, -7876.7319335938, 293947.03125, large=True, slot_name="14", heli=False)
        krymsk.parking_slots[102] = ParkingSlot(102, -7948.3583984375, 293886.6875, large=True, slot_name="15", heli=False)
        krymsk.parking_slots[104] = ParkingSlot(104, -6325.6552734375, 295041.5, large=False, slot_name="50", heli=False)
        krymsk.parking_slots[107] = ParkingSlot(107, -6351.4077148438, 295139.9375, large=False, slot_name="48", heli=False)
        krymsk.parking_slots[108] = ParkingSlot(108, -6280.3999023438, 295124.0625, large=False, slot_name="49", heli=False)
        krymsk.parking_slots[110] = ParkingSlot(110, -7765.9921875, 294391.1875, large=False, slot_name="26", heli=False)
        krymsk.parking_slots[112] = ParkingSlot(112, -7843.90234375, 294456.6875, large=False, slot_name="24", heli=False)
        krymsk.parking_slots[113] = ParkingSlot(113, -7776.7807617188, 294484.75, large=False, slot_name="25", heli=False)
        krymsk.parking_slots[115] = ParkingSlot(115, -7801.1469726563, 294264.84375, large=False, slot_name="23", heli=False)
        krymsk.parking_slots[118] = ParkingSlot(118, -7879.0571289063, 294330.34375, large=False, slot_name="21", heli=False)
        krymsk.parking_slots[119] = ParkingSlot(119, -7811.935546875, 294358.40625, large=False, slot_name="58", heli=False)
        krymsk.parking_slots[121] = ParkingSlot(121, -7615.4453125, 293915.96875, large=False, slot_name="11", heli=False)
        krymsk.parking_slots[124] = ParkingSlot(124, -7713.9541015625, 293890.4375, large=False, slot_name="09", heli=False)
        krymsk.parking_slots[125] = ParkingSlot(125, -7697.9487304688, 293961.34375, large=False, slot_name="10", heli=False)
        krymsk.unit_zones.append(mapping.Rectangle(-6292.8571428566, 295422.85714286, -7292.8571428566, 296422.85714286))
        krymsk.unit_zones.append(mapping.Rectangle(-5878.5714285709, 292315.71428571, -6878.5714285709, 293315.71428571))
        krymsk.unit_zones.append(mapping.Rectangle(-4885.7142857137, 293180, -5885.7142857137, 294180))
        krymsk.unit_zones.append(mapping.Rectangle(-5414.2857142852, 295651.42857143, -6214.2857142852, 296451.42857143))
        ...
        maykop.unit_zones.append(mapping.Rectangle(-24574.285714285, 455938.57142857, -26574.285714285, 457938.57142857))
        maykop.unit_zones.append(mapping.Rectangle(-26888.571428571, 459010, -29088.571428571, 461210))
        maykop.unit_zones.append(mapping.Rectangle(-24917.142857142, 459945.71428572, -26717.142857142, 461745.71428572))
        maykop.unit_zones.append(mapping.Rectangle(-29138.57142857, 457451.42857144, -30738.57142857, 459051.42857144))
        ...
        gelendzhik.unit_zones.append(mapping.Rectangle(-50072.857142857, 296894.28571429, -50972.857142857, 297794.28571429))
        gelendzhik.unit_zones.append(mapping.Rectangle(-49435.714285714, 296528.57142857, -50135.714285714, 297228.57142857))
        gelendzhik.unit_zones.append(mapping.Rectangle(-50470, 298271.42857143, -51170, 298971.42857143))
        gelendzhik.unit_zones.append(mapping.Rectangle(-48665.714285714, 297704.28571428, -49265.714285714, 298304.28571428))
        ...
        krasnodar_pashkovsky.unit_zones.append(mapping.Rectangle(8105.7142857243, 388292.85714286, 6705.7142857243, 389692.85714286))
        krasnodar_pashkovsky.unit_zones.append(mapping.Rectangle(7184.2857142957, 384857.14285715, 6184.2857142957, 385857.14285715))
        krasnodar_pashkovsky.unit_zones.append(mapping.Rectangle(8848.5714285814, 386628.57142858, 7948.571428581399, 387528.57142858))
        krasnodar_pashkovsky.unit_zones.append(mapping.Rectangle(9570.0000000098, 383164.28571429, 8570.0000000098, 384164.28571429))
        ...
        sukhumi.parking_slots[9] = ParkingSlot(9, -219863.984375, 563508.6875, large=True, slot_name="23", heli=False)
        sukhumi.parking_slots[10] = ParkingSlot(10, -219887.796875, 563586.0625, large=True, slot_name="22", heli=False)
        sukhumi.parking_slots[12] = ParkingSlot(12, -219911.09375, 563654.5625, large=True, slot_name="21", heli=False)
        sukhumi.parking_slots[22] = ParkingSlot(22, -219760.4375, 563975.125, large=False, slot_name="05", heli=True)
        sukhumi.parking_slots[26] = ParkingSlot(26, -219710.328125, 564235, large=False, slot_name="12", heli=True)
        sukhumi.parking_slots[27] = ParkingSlot(27, -219830.765625, 564130.75, large=False, slot_name="15", heli=True)
        sukhumi.parking_slots[29] = ParkingSlot(29, -219791.421875, 563737, large=True, slot_name="02", heli=False)
        sukhumi.parking_slots[30] = ParkingSlot(30, -219773.0625, 563880.4375, large=True, slot_name="03", heli=False)
        sukhumi.parking_slots[31] = ParkingSlot(31, -219733.421875, 563743.375, large=True, slot_name="01", heli=False)
        sukhumi.parking_slots[42] = ParkingSlot(42, -219714.203125, 564198, large=False, slot_name="11", heli=True)
        sukhumi.parking_slots[45] = ParkingSlot(45, -219701.984375, 564314.5625, large=False, slot_name="14", heli=True)
        sukhumi.parking_slots[46] = ParkingSlot(46, -219706.140625, 564274.8125, large=False, slot_name="13", heli=True)
        sukhumi.parking_slots[47] = ParkingSlot(47, -219809.890625, 564329.5, large=False, slot_name="20", heli=True)
        sukhumi.parking_slots[48] = ParkingSlot(48, -219814.046875, 564289.875, large=False, slot_name="19", heli=True)
        sukhumi.parking_slots[49] = ParkingSlot(49, -219818.21875, 564250.0625, large=False, slot_name="18", heli=True)
        sukhumi.parking_slots[50] = ParkingSlot(50, -219822.40625, 564210.3125, large=False, slot_name="17", heli=True)
        sukhumi.parking_slots[51] = ParkingSlot(51, -219826.59375, 564170.5, large=False, slot_name="16", heli=True)
        sukhumi.parking_slots[52] = ParkingSlot(52, -219740.046875, 564173.4375, large=False, slot_name="10", heli=True)
        sukhumi.parking_slots[53] = ParkingSlot(53, -219743.703125, 564134.25, large=False, slot_name="09", heli=True)
        sukhumi.parking_slots[54] = ParkingSlot(54, -219747.890625, 564094.5, large=False, slot_name="08", heli=True)
        sukhumi.parking_slots[55] = ParkingSlot(55, -219752.0625, 564054.6875, large=False, slot_name="07", heli=True)
        sukhumi.parking_slots[56] = ParkingSlot(56, -219756.25, 564014.9375, large=False, slot_name="06", heli=True)
        sukhumi.parking_slots[57] = ParkingSlot(57, -219760.46875, 563934.625, large=True, slot_name="04", heli=False)
        sukhumi.unit_zones.append(mapping.Rectangle(-220484.28571428, 563282.85714286, -221084.28571428, 563882.85714286))
        sukhumi.unit_zones.append(mapping.Rectangle(-220081.42857143, 562380.00000001, -220681.42857143, 562980.00000001))
        sukhumi.unit_zones.append(mapping.Rectangle(-218804.28571429, 564057.14285715, -219404.28571429, 564657.14285715))
        sukhumi.unit_zones.append(mapping.Rectangle(-218895.71428571, 563268.57142858, -219495.71428571, 563868.57142858))
        sukhumi.unit_zones.append(mapping.Rectangle(-221415.71428571, 565074.28571429, -222015.71428571, 565674.28571429))
        ...
        gudauta.parking_slots[8] = ParkingSlot(8, -197846.828125, 516550.125, large=True, slot_name="04", heli=False)
        gudauta.parking_slots[9] = ParkingSlot(9, -197795.75, 516441.59375, large=True, slot_name="06", heli=False)
        gudauta.parking_slots[10] = ParkingSlot(10, -197821.296875, 516495.8125, large=True, slot_name="05", heli=False)
        gudauta.parking_slots[11] = ParkingSlot(11, -197872.375, 516604.375, large=True, slot_name="03", heli=False)
        gudauta.parking_slots[12] = ParkingSlot(12, -197897.9375, 516658.6875, large=True, slot_name="02", heli=False)
        gudauta.parking_slots[13] = ParkingSlot(13, -197923.484375, 516713.03125, large=True, slot_name="01", heli=False)
        gudauta.parking_slots[14] = ParkingSlot(14, -197744.65625, 516333, large=True, slot_name="08", heli=False)
        gudauta.parking_slots[17] = ParkingSlot(17, -197770.203125, 516387.21875, large=True, slot_name="07", heli=False)
        gudauta.parking_slots[18] = ParkingSlot(18, -197693.5625, 516224.4375, large=True, slot_name="10", heli=False)
        gudauta.parking_slots[21] = ParkingSlot(21, -197719.109375, 516278.65625, large=True, slot_name="09", heli=False)
        gudauta.parking_slots[24] = ParkingSlot(24, -196349.828125, 515792, large=False, slot_name="26", heli=False)
        gudauta.parking_slots[26] = ParkingSlot(26, -196434.640625, 515787.34375, large=False, slot_name="27", heli=False)
        gudauta.parking_slots[27] = ParkingSlot(27, -196420.78125, 515879.4375, large=False, slot_name="28", heli=False)
        gudauta.parking_slots[30] = ParkingSlot(30, -196404.984375, 515691.71875, large=False, slot_name="23", heli=False)
        gudauta.parking_slots[32] = ParkingSlot(32, -196489.78125, 515687.09375, large=False, slot_name="24", heli=False)
        gudauta.parking_slots[33] = ParkingSlot(33, -196475.921875, 515779.21875, large=False, slot_name="25", heli=False)
        gudauta.parking_slots[37] = ParkingSlot(37, -196704.65625, 515788.1875, large=False, slot_name="17", heli=False)
        gudauta.parking_slots[39] = ParkingSlot(39, -196619.84375, 515792.84375, large=False, slot_name="18", heli=False)
        gudauta.parking_slots[40] = ParkingSlot(40, -196633.703125, 515700.75, large=False, slot_name="19", heli=False)
        gudauta.parking_slots[43] = ParkingSlot(43, -196649.5, 515888.46875, large=False, slot_name="29", heli=False)
        gudauta.parking_slots[44] = ParkingSlot(44, -196564.703125, 515893.09375, large=False, slot_name="30", heli=False)
        gudauta.parking_slots[45] = ParkingSlot(45, -196578.5625, 515800.96875, large=False, slot_name="31", heli=False)
        gudauta.parking_slots[48] = ParkingSlot(48, -196460.125, 515591.1875, large=False, slot_name="20", heli=False)
        gudauta.parking_slots[50] = ParkingSlot(50, -196544.9375, 515586.53125, large=False, slot_name="21", heli=False)
        gudauta.parking_slots[51] = ParkingSlot(51, -196531.078125, 515678.625, large=False, slot_name="22", heli=False)
        gudauta.parking_slots[54] = ParkingSlot(54, -196515.28125, 515490.90625, large=False, slot_name="11", heli=False)
        gudauta.parking_slots[56] = ParkingSlot(56, -196600.078125, 515486.28125, large=False, slot_name="12", heli=False)
        gudauta.parking_slots[57] = ParkingSlot(57, -196586.21875, 515578.40625, large=False, slot_name="13", heli=False)
        gudauta.parking_slots[60] = ParkingSlot(60, -196759.609375, 515688.28125, large=False, slot_name="14", heli=False)
        gudauta.parking_slots[62] = ParkingSlot(62, -196674.796875, 515692.9375, large=False, slot_name="15", heli=False)
        gudauta.parking_slots[63] = ParkingSlot(63, -196688.65625, 515600.84375, large=False, slot_name="16", heli=False)
        gudauta.unit_zones.append(mapping.Rectangle(-196705.71428572, 516900, -197405.71428572, 517600))
        gudauta.unit_zones.append(mapping.Rectangle(-195732.85714286, 514945.71428571, -196332.85714286, 515545.71428571))
        gudauta.unit_zones.append(mapping.Rectangle(-195075.71428572, 516880, -195875.71428572, 517680))
        ...
        batumi.unit_zones.append(mapping.Rectangle(-356160, 616688.00000003, -356960, 617488.00000003))
        batumi.unit_zones.append(mapping.Rectangle(-357551.42857143, 614990.85714289, -358551.42857143, 615990.85714289))
        batumi.unit_zones.append(mapping.Rectangle(-355574.28571429, 615740.85714289, -356474.28571429, 616640.85714289))
        ...
        senaki.parking_slots[4] = ParkingSlot(4, -281508.78125, 648224.25, large=False, slot_name="60", heli=False)
        senaki.parking_slots[6] = ParkingSlot(6, -281620.4375, 648117.6875, large=False, slot_name="59", heli=False)
        senaki.parking_slots[8] = ParkingSlot(8, -281484.71875, 648004.4375, large=False, slot_name="57", heli=True)
        senaki.parking_slots[10] = ParkingSlot(10, -281610.125, 647992.125, large=False, slot_name="58", heli=False)
        senaki.parking_slots[11] = ParkingSlot(11, -281626.65625, 647900.5, large=False, slot_name="56", heli=False)
        senaki.parking_slots[13] = ParkingSlot(13, -281480.34375, 647871.5625, large=False, slot_name="55", heli=False)
        senaki.parking_slots[14] = ParkingSlot(14, -281606.84375, 647805.8125, large=False, slot_name="54", heli=False)
        senaki.parking_slots[16] = ParkingSlot(16, -281585.71875, 647848.4375, large=False, slot_name="53", heli=False)
        senaki.parking_slots[17] = ParkingSlot(17, -281451.375, 647818.5625, large=False, slot_name="52", heli=False)
        senaki.parking_slots[19] = ParkingSlot(19, -281605.375, 647714.625, large=False, slot_name="51", heli=False)
        senaki.parking_slots[21] = ParkingSlot(21, -281463.09375, 647680.5625, large=False, slot_name="50", heli=False)
        senaki.parking_slots[22] = ParkingSlot(22, -281436.125, 647633.1875, large=False, slot_name="48", heli=False)
        senaki.parking_slots[24] = ParkingSlot(24, -281570.65625, 647665.0625, large=False, slot_name="49", heli=False)
        senaki.parking_slots[26] = ParkingSlot(26, -281395.0625, 646840.875, large=False, slot_name="30", heli=False)
        senaki.parking_slots[28] = ParkingSlot(28, -281506.53125, 646732.3125, large=False, slot_name="29", heli=False)
        senaki.parking_slots[32] = ParkingSlot(32, -281392.3125, 647552.6875, large=False, slot_name="32", heli=False)
        senaki.parking_slots[34] = ParkingSlot(34, -281437.1875, 647462.5625, large=False, slot_name="31", heli=False)
        senaki.parking_slots[35] = ParkingSlot(35, -281390.15625, 647409.6875, large=False, slot_name="33", heli=False)
        senaki.parking_slots[37] = ParkingSlot(37, -281298.46875, 647460.1875, large=False, slot_name="34", heli=False)
        senaki.parking_slots[40] = ParkingSlot(40, -281251.0625, 647428.625, large=False, slot_name="39", heli=False)
        senaki.parking_slots[42] = ParkingSlot(42, -281331.65625, 647260.125, large=False, slot_name="38", heli=False)
        senaki.parking_slots[43] = ParkingSlot(43, -281372.1875, 647351.3125, large=False, slot_name="36", heli=False)
        senaki.parking_slots[44] = ParkingSlot(44, -281340.5, 647387.375, large=False, slot_name="35", heli=False)
        senaki.parking_slots[45] = ParkingSlot(45, -281248.90625, 647285.625, large=False, slot_name="41", heli=False)
        senaki.parking_slots[47] = ParkingSlot(47, -281156.90625, 647346.1875, large=False, slot_name="40", heli=False)
        senaki.parking_slots[50] = ParkingSlot(50, -281135.03125, 647212.1875, large=False, slot_name="43", heli=False)
        senaki.parking_slots[51] = ParkingSlot(51, -281160.34375, 647165.25, large=False, slot_name="44", heli=False)
        senaki.parking_slots[53] = ParkingSlot(53, -281201.84375, 647127.125, large=False, slot_name="45", heli=False)
        senaki.parking_slots[55] = ParkingSlot(55, -281255.09375, 647204, large=False, slot_name="47", heli=False)
        senaki.parking_slots[57] = ParkingSlot(57, -281104.375, 647307.75, large=False, slot_name="42", heli=False)
        senaki.parking_slots[62] = ParkingSlot(62, -281379.375, 646756.6875, large=False, slot_name="16", heli=False)
        senaki.parking_slots[70] = ParkingSlot(70, -281391.34375, 646184, large=False, slot_name="07", heli=False)
        senaki.parking_slots[71] = ParkingSlot(71, -281296.34375, 646191, large=False, slot_name="09", heli=False)
        senaki.parking_slots[72] = ParkingSlot(72, -281350.96875, 646101.125, large=False, slot_name="08", heli=False)
        senaki.parking_slots[74] = ParkingSlot(74, -281231.53125, 646209.375, large=False, slot_name="10", heli=False)
        senaki.parking_slots[76] = ParkingSlot(76, -281212.25, 646248.875, large=False, slot_name="11", heli=False)
        senaki.parking_slots[78] = ParkingSlot(78, -281277.25, 646359.8125, large=False, slot_name="13", heli=False)
        senaki.parking_slots[79] = ParkingSlot(79, -281466.90625, 646396.5, large=False, slot_name="06", heli=False)
        senaki.parking_slots[80] = ParkingSlot(80, -281365.1875, 646605.875, large=False, slot_name="14", heli=False)
        senaki.parking_slots[82] = ParkingSlot(82, -281198.4375, 646762.4375, large=False, slot_name="18", heli=False)
        senaki.parking_slots[83] = ParkingSlot(83, -281114.4375, 646872.5625, large=False, slot_name="20", heli=False)
        senaki.parking_slots[85] = ParkingSlot(85, -281208.46875, 646989.125, large=False, slot_name="23", heli=False)
        senaki.parking_slots[86] = ParkingSlot(86, -281172.21875, 647061.625, large=False, slot_name="22", heli=False)
        senaki.parking_slots[88] = ParkingSlot(88, -281012.65625, 646951.75, large=False, slot_name="21", heli=False)
        senaki.parking_slots[90] = ParkingSlot(90, -281239.40625, 646910.5625, large=False, slot_name="24", heli=False)
        senaki.parking_slots[94] = ParkingSlot(94, -281352.09375, 646879.875, large=False, slot_name="28", heli=False)
        senaki.parking_slots[95] = ParkingSlot(95, -281290.125, 646987.4375, large=False, slot_name="25", heli=False)
        senaki.parking_slots[97] = ParkingSlot(97, -281335.625, 646976.3125, large=False, slot_name="26", heli=False)
        senaki.parking_slots[98] = ParkingSlot(98, -281385.78125, 646924.1875, large=False, slot_name="27", heli=False)
        senaki.parking_slots[101] = ParkingSlot(101, -281213.65625, 646332.625, large=False, slot_name="12", heli=False)
        senaki.parking_slots[105] = ParkingSlot(105, -281265.40625, 647124.4375, large=False, slot_name="46", heli=False)
        senaki.parking_slots[107] = ParkingSlot(107, -281388.34375, 647272.375, large=False, slot_name="69", heli=False)
        senaki.parking_slots[108] = ParkingSlot(108, -281613.75, 648362.125, large=False, slot_name="61", heli=False)
        senaki.parking_slots[109] = ParkingSlot(109, -281619.03125, 646385.625, large=True, slot_name="01", heli=False)
        senaki.parking_slots[111] = ParkingSlot(111, -281577.53125, 646430.8125, large=False, slot_name="02", heli=True)
        senaki.parking_slots[113] = ParkingSlot(113, -281538.28125, 646474.4375, large=True, slot_name="03", heli=False)
        senaki.parking_slots[115] = ParkingSlot(115, -281495.90625, 646520.5625, large=False, slot_name="04", heli=True)
        senaki.parking_slots[117] = ParkingSlot(117, -281457.5, 646563.1875, large=True, slot_name="05", heli=False)
        senaki.parking_slots[119] = ParkingSlot(119, -281337.96875, 646694.25, large=False, slot_name="15", heli=True)
        senaki.parking_slots[120] = ParkingSlot(120, -281279.15625, 646758.9375, large=False, slot_name="17", heli=True)
        senaki.parking_slots[121] = ParkingSlot(121, -281191.5625, 646855.125, large=False, slot_name="19", heli=True)
        senaki.parking_slots[123] = ParkingSlot(123, -281415.78125, 648105.9375, large=False, slot_name="63", heli=True)
        senaki.parking_slots[124] = ParkingSlot(124, -281521.46875, 648100.875, large=False, slot_name="62", heli=True)
        senaki.parking_slots[129] = ParkingSlot(129, -281636.28125, 648069.5, large=False, slot_name="64", heli=True)
        senaki.parking_slots[130] = ParkingSlot(130, -281665, 648066.25, large=False, slot_name="65", heli=True)
        senaki.parking_slots[131] = ParkingSlot(131, -281693.0625, 648063.3125, large=False, slot_name="66", heli=True)
        senaki.parking_slots[132] = ParkingSlot(132, -281724.6875, 648060.75, large=False, slot_name="67", heli=True)
        senaki.parking_slots[133] = ParkingSlot(133, -281336.53125, 647506.5, large=False, slot_name="68", heli=True)
        senaki.unit_zones.append(mapping.Rectangle(-281829.99999999, 646374.2857143, -282629.99999999, 647174.2857143))
        senaki.unit_zones.append(mapping.Rectangle(-280231.42857142, 645832.85714287, -280931.42857142, 646532.85714287))
        senaki.unit_zones.append(mapping.Rectangle(-282110, 645288.57142859, -282910, 646088.57142859))
        senaki.unit_zones.append(mapping.Rectangle(-281052.85714285, 648450.00000002, -281452.85714285, 648850.00000002))
        ...
        kobuleti.unit_zones.append(mapping.Rectangle(-319184.85714285, 636121.14285715, -320584.85714285, 637521.14285715))
        kobuleti.unit_zones.append(mapping.Rectangle(-317053.42857142, 634509.71428572, -317553.42857142, 635009.71428572))
        kobuleti.unit_zones.append(mapping.Rectangle(-317776.28571428, 634158.28571429, -318276.28571428, 634658.28571429))
        ...
        kutaisi.unit_zones.append(mapping.Rectangle(-285691.42857142, 683870.00000001, -286691.42857142, 684870.00000001))
        kutaisi.unit_zones.append(mapping.Rectangle(-285131.42857142, 685257.14285716, -286131.42857142, 686257.14285716))
        kutaisi.unit_zones.append(mapping.Rectangle(-283062.85714285, 682065.71428573, -283762.85714285, 682765.71428573))
        kutaisi.unit_zones.append(mapping.Rectangle(-283252.85714285, 685130.00000001, -283752.85714285, 685630.00000001))
        ...
        mineralnye.unit_zones.append(mapping.Rectangle(-50675.714285712, 706205.71428572, -51275.714285712, 706805.71428572))
        mineralnye.unit_zones.append(mapping.Rectangle(-52302.857142855, 704720, -53002.857142855, 705420))
        mineralnye.unit_zones.append(mapping.Rectangle(-51194.285714284, 701500, -52594.285714284, 702900))
        mineralnye.unit_zones.append(mapping.Rectangle(-48049.999999998, 706642.85714286, -48849.999999998, 707442.85714286))
        ...
        lochini.unit_zones.append(mapping.Rectangle(-315025.71428571, 894574.28571429, -316225.71428571, 895774.28571429))
        lochini.unit_zones.append(mapping.Rectangle(-316225.71428571, 896138.57142857, -317425.71428571, 897338.57142857))
        lochini.unit_zones.append(mapping.Rectangle(-314582.85714286, 897795.71428571, -315982.85714286, 899195.71428571))
        ...
        soganlug.unit_zones.append(mapping.Rectangle(-318431.42857142, 894650.00000001, -318931.42857142, 895150.00000001))
        soganlug.unit_zones.append(mapping.Rectangle(-318949.99999999, 894894.28571429, -319549.99999999, 895494.28571429))
        soganlug.unit_zones.append(mapping.Rectangle(-318215.7142857, 897200.00000001, -319215.7142857, 898200.00000001))
        self.airports[soganlug.name] = soganlug

        vaziani = Airport(31, "Vaziani", 140.0, -319069.063, 903150.625, None)
        vaziani.civilian = False
        vaziani.runways.append(Runway(140, 108.75))
        vaziani.runways.append(Runway(320, 108.75))
        vaziani.parking_slots[3] = ParkingSlot(3, -317519.15625, 903209.375, large=False, slot_name="25", heli=False)
        vaziani.parking_slots[11] = ParkingSlot(11, -318048.375, 902475.5625, large=True, slot_name="01", heli=False)
        vaziani.parking_slots[13] = ParkingSlot(13, -318088.9375, 902514.4375, large=True, slot_name="02", heli=False)
        vaziani.parking_slots[15] = ParkingSlot(15, -318124.75, 902549.1875, large=True, slot_name="03", heli=False)
        vaziani.parking_slots[17] = ParkingSlot(17, -318167.3125, 902591.9375, large=True, slot_name="04", heli=False)
        vaziani.parking_slots[22] = ParkingSlot(22, -319623.0625, 904241.25, large=True, slot_name="79", heli=False)
        vaziani.parking_slots[26] = ParkingSlot(26, -319753.25, 904275.1875, large=True, slot_name="09", heli=False)
        vaziani.parking_slots[28] = ParkingSlot(28, -319783.5625, 904239.5625, large=True, slot_name="08", heli=False)
        vaziani.parking_slots[29] = ParkingSlot(29, -319858.53125, 904159, large=False, slot_name="05", heli=True)
        vaziani.parking_slots[34] = ParkingSlot(34, -317993.84375, 902709.875, large=False, slot_name="11", heli=False)
        vaziani.parking_slots[35] = ParkingSlot(35, -318059.53125, 902639.6875, large=False, slot_name="10", heli=False)
        vaziani.parking_slots[37] = ParkingSlot(37, -317935.90625, 902714.9375, large=False, slot_name="13", heli=False)
        vaziani.parking_slots[38] = ParkingSlot(38, -317923.0625, 902609.3125, large=False, slot_name="12", heli=False)
        vaziani.parking_slots[40] = ParkingSlot(40, -317868.28125, 902587.625, large=False, slot_name="14", heli=False)
        vaziani.parking_slots[42] = ParkingSlot(42, -317947.8125, 902877.1875, large=False, slot_name="16", heli=False)
        vaziani.parking_slots[44] = ParkingSlot(44, -317837.84375, 902896.4375, large=False, slot_name="18", heli=False)
        vaziani.parking_slots[46] = ParkingSlot(46, -317881.65625, 902816.6875, large=False, slot_name="15", heli=False)
        vaziani.parking_slots[48] = ParkingSlot(48, -317629.125, 902843.1875, large=False, slot_name="21", heli=False)
        vaziani.parking_slots[49] = ParkingSlot(49, -317699.46875, 902898.5625, large=False, slot_name="22", heli=False)
        vaziani.parking_slots[51] = ParkingSlot(51, -317737.40625, 902815.9375, large=False, slot_name="19", heli=False)
        vaziani.parking_slots[53] = ParkingSlot(53, -317696, 902803.75, large=False, slot_name="20", heli=False)
        vaziani.parking_slots[55] = ParkingSlot(55, -317855.1875, 903263.9375, large=False, slot_name="28", heli=False)
        vaziani.parking_slots[57] = ParkingSlot(57, -317766.96875, 903280.1875, large=False, slot_name="27", heli=False)
        vaziani.parking_slots[59] = ParkingSlot(59, -317772.09375, 903189.3125, large=False, slot_name="30", heli=False)
        vaziani.parking_slots[60] = ParkingSlot(60, -317814.5625, 903198, large=False, slot_name="29", heli=False)
        vaziani.parking_slots[62] = ParkingSlot(62, -317589.46875, 903264.75, large=False, slot_name="26", heli=False)
        vaziani.parking_slots[64] = ParkingSlot(64, -317627.4375, 903182.125, large=False, slot_name="23", heli=False)
        vaziani.parking_slots[65] = ParkingSlot(65, -317586, 903169.9375, large=False, slot_name="24", heli=False)
        vaziani.parking_slots[69] = ParkingSlot(69, -318171.875, 902714.8125, large=False, slot_name="31", heli=False)
        vaziani.parking_slots[71] = ParkingSlot(71, -318161.53125, 902842.25, large=False, slot_name="33", heli=False)
        vaziani.parking_slots[73] = ParkingSlot(73, -318249.21875, 902737.3125, large=False, slot_name="32", heli=False)
        vaziani.parking_slots[74] = ParkingSlot(74, -318238.625, 902904.0625, large=False, slot_name="35", heli=True)
        vaziani.parking_slots[76] = ParkingSlot(76, -318317.5, 902845.1875, large=False, slot_name="34", heli=False)
        vaziani.parking_slots[77] = ParkingSlot(77, -318372.3125, 902884.625, large=False, slot_name="36", heli=False)
        vaziani.parking_slots[79] = ParkingSlot(79, -318307.71875, 902972.125, large=False, slot_name="37", heli=True)
        vaziani.parking_slots[80] = ParkingSlot(80, -318388.15625, 903087.9375, large=False, slot_name="39", heli=False)
        vaziani.parking_slots[82] = ParkingSlot(82, -318466.4375, 902994.5625, large=False, slot_name="38", heli=False)
        vaziani.parking_slots[83] = ParkingSlot(83, -318379.34375, 903159.625, large=False, slot_name="41", heli=False)
        vaziani.parking_slots[85] = ParkingSlot(85, -318515.96875, 903105.5, large=False, slot_name="40", heli=False)
        vaziani.parking_slots[86] = ParkingSlot(86, -318462.9375, 903208.625, large=False, slot_name="42", heli=False)
        vaziani.parking_slots[88] = ParkingSlot(88, -318596.71875, 903207.6875, large=False, slot_name="45", heli=False)
        vaziani.parking_slots[90] = ParkingSlot(90, -318627.6875, 903244.375, large=False, slot_name="44", heli=False)
        vaziani.parking_slots[92] = ParkingSlot(92, -318695.125, 903247.875, large=False, slot_name="43", heli=False)
        vaziani.parking_slots[93] = ParkingSlot(93, -318479.28125, 903285.4375, large=False, slot_name="47", heli=False)
        vaziani.parking_slots[95] = ParkingSlot(95, -318593.1875, 903320.8125, large=False, slot_name="46", heli=False)
        vaziani.parking_slots[96] = ParkingSlot(96, -318486.875, 903378.3125, large=False, slot_name="49", heli=False)
        vaziani.parking_slots[98] = ParkingSlot(98, -318603.75, 903414, large=False, slot_name="48", heli=False)
        vaziani.parking_slots[99] = ParkingSlot(99, -318489.59375, 903508.8125, large=False, slot_name="50", heli=False)
        vaziani.parking_slots[101] = ParkingSlot(101, -318570.65625, 903564.5, large=False, slot_name="51", heli=False)
        vaziani.parking_slots[103] = ParkingSlot(103, -318832.78125, 903551.25, large=False, slot_name="55", heli=False)
        vaziani.parking_slots[105] = ParkingSlot(105, -318752.9375, 903513.3125, large=False, slot_name="54", heli=False)
        vaziani.parking_slots[106] = ParkingSlot(106, -318711.90625, 903552.375, large=False, slot_name="53", heli=False)
        vaziani.parking_slots[108] = ParkingSlot(108, -318798.75, 903597.3125, large=False, slot_name="56", heli=False)
        vaziani.parking_slots[110] = ParkingSlot(110, -318649.9375, 903679.0625, large=False, slot_name="52", heli=False)
        vaziani.parking_slots[112] = ParkingSlot(112, -318776.75, 903750, large=False, slot_name="58", heli=False)
        vaziani.parking_slots[114] = ParkingSlot(114, -318822.15625, 903644.1875, large=False, slot_name="57", heli=False)
        vaziani.parking_slots[115] = ParkingSlot(115, -318845.28125, 903815.0625, large=False, slot_name="60", heli=False)
        vaziani.parking_slots[117] = ParkingSlot(117, -318910.84375, 903690.9375, large=False, slot_name="59", heli=False)
        vaziani.parking_slots[118] = ParkingSlot(118, -318952.9375, 903772.75, large=False, slot_name="62", heli=False)
        vaziani.parking_slots[120] = ParkingSlot(120, -318913.0625, 903854.6875, large=False, slot_name="61", heli=True)
        vaziani.parking_slots[123] = ParkingSlot(123, -319072.78125, 903773.5, large=False, slot_name="64", heli=False)
        vaziani.parking_slots[124] = ParkingSlot(124, -319027.25, 903910.625, large=False, slot_name="65", heli=False)
        vaziani.parking_slots[125] = ParkingSlot(125, -319135.25, 903789.3125, large=False, slot_name="67", heli=False)
        vaziani.parking_slots[127] = ParkingSlot(127, -319125.21875, 903881, large=False, slot_name="66", heli=True)
        vaziani.parking_slots[128] = ParkingSlot(128, -319026.84375, 903982.875, large=False, slot_name="80", heli=False)
        vaziani.parking_slots[130] = ParkingSlot(130, -319044.28125, 904303.4375, large=False, slot_name="90", heli=False)
        vaziani.parking_slots[132] = ParkingSlot(132, -318994.40625, 904258.875, large=False, slot_name="91", heli=False)
        vaziani.parking_slots[133] = ParkingSlot(133, -319096.25, 904228, large=False, slot_name="89", heli=False)
        vaziani.parking_slots[135] = ParkingSlot(135, -319119, 904181.25, large=False, slot_name="88", heli=False)
        vaziani.parking_slots[137] = ParkingSlot(137, -319132.8125, 904128.5625, large=False, slot_name="87", heli=False)
        vaziani.parking_slots[139] = ParkingSlot(139, -319120.15625, 904039.125, large=False, slot_name="81", heli=False)
        vaziani.parking_slots[141] = ParkingSlot(141, -319164.25, 904038.8125, large=False, slot_name="82", heli=False)
        vaziani.parking_slots[143] = ParkingSlot(143, -319290.78125, 904101.4375, large=False, slot_name="84", heli=False)
        vaziani.parking_slots[145] = ParkingSlot(145, -319184.1875, 904158, large=False, slot_name="86", heli=False)
        vaziani.parking_slots[147] = ParkingSlot(147, -319214.75, 904053.8125, large=False, slot_name="83", heli=False)
        vaziani.parking_slots[149] = ParkingSlot(149, -319249.71875, 904140.375, large=False, slot_name="85", heli=False)
        vaziani.parking_slots[151] = ParkingSlot(151, -319192.28125, 903808.125, large=False, slot_name="68", heli=False)
        vaziani.parking_slots[154] = ParkingSlot(154, -319223.6875, 903906.0625, large=False, slot_name="69", heli=True)
        vaziani.parking_slots[156] = ParkingSlot(156, -319284.46875, 903838.875, large=False, slot_name="70", heli=False)
        vaziani.parking_slots[157] = ParkingSlot(157, -319296.59375, 903964.3125, large=False, slot_name="92", heli=True)
        vaziani.parking_slots[160] = ParkingSlot(160, -319387.59375, 903909.8125, large=False, slot_name="72", heli=False)
        vaziani.parking_slots[161] = ParkingSlot(161, -319428.09375, 903958.5625, large=False, slot_name="73", heli=False)
        vaziani.parking_slots[163] = ParkingSlot(163, -319487.03125, 904033.625, large=False, slot_name="75", heli=False)
        vaziani.parking_slots[165] = ParkingSlot(165, -319444.21875, 904085.0625, large=False, slot_name="76", heli=True)
        vaziani.parking_slots[166] = ParkingSlot(166, -319513.25, 904150.1875, large=False, slot_name="77", heli=True)
        vaziani.parking_slots[167] = ParkingSlot(167, -319559.8125, 904095.375, large=False, slot_name="74", heli=False)
        vaziani.parking_slots[168] = ParkingSlot(168, -317878.21875, 902911.625, large=False, slot_name="17", heli=False)
        vaziani.parking_slots[172] = ParkingSlot(172, -319010.875, 903766.25, large=False, slot_name="63", heli=False)
        vaziani.parking_slots[173] = ParkingSlot(173, -319340.96875, 903867.75, large=False, slot_name="71", heli=False)
        vaziani.parking_slots[175] = ParkingSlot(175, -319840.125, 904183.375, large=False, slot_name="06", heli=True)
        vaziani.parking_slots[176] = ParkingSlot(176, -319821.0625, 904207.125, large=False, slot_name="07", heli=True)
        vaziani.parking_slots[177] = ParkingSlot(177, -319599.15625, 904222.375, large=False, slot_name="78", heli=True)
        vaziani.unit_zones.append(mapping.Rectangle(-318605.71428571, 901664.28571429, -319605.71428571, 902664.28571429))
        vaziani.unit_zones.append(mapping.Rectangle(-319434.28571428, 902484.28571429, -320434.28571428, 903484.28571429))
        vaziani.unit_zones.append(mapping.Rectangle(-318435.71428571, 904565.71428572, -319435.71428571, 905565.71428572))
        vaziani.unit_zones.append(mapping.Rectangle(-316582.85714285, 903304.28571429, -317582.85714285, 904304.28571429))
