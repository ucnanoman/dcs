...
class BasicTests(unittest.TestCase):
    ...
    def test_finding(self):
        ...
        pg = m.plane_group_inflight(usa, "Airgroup 1", dcs.planes.A_10C, dcs.Point(pos.x + 200, pos.y + 200), 2000)
        self.assertIsInstance(pg, dcs.unitgroup.PlaneGroup)
        pg = m.plane_group_inflight(usa, "Airgroup 2", dcs.planes.M_2000C, dcs.Point(pos.x + 200, pos.y + 200), 2000)
        self.assertIsInstance(pg, dcs.unitgroup.PlaneGroup)
