...
class Creech(Airport):
    ...
    def __init__(self, terrain: Terrain) -> None:
        ...
        self.runways.append(Runway(id=2, name='13-31', main=RunwayApproach(name='13', heading=130), opposite=RunwayApproach(name='31', heading=310)))
...
class Groom_Lake(Airport):
    ...
    def __init__(self, terrain: Terrain) -> None:
        ...
        self.runways.append(Runway(id=1, name='32-14', main=RunwayApproach(name='32', heading=320), opposite=RunwayApproach(name='14', heading=140)))
        self.parking_slots.append(ParkingSlot(
...
class McCarran_International(Airport):
    ...
    def __init__(self, terrain: Terrain) -> None:
        ...
        self.runways.append(Runway(id=1, name='7R-25L', main=RunwayApproach(name='7R', heading=70), opposite=RunwayApproach(name='25L', heading=250)))
        self.runways.append(Runway(id=2, name='7L-25R', main=RunwayApproach(name='7L', heading=70), opposite=RunwayApproach(name='25R', heading=250)))
        self.parking_slots.append(ParkingSlot(
...
class Nellis(Airport):
    ...
    def __init__(self, terrain: Terrain) -> None:
        ...
        self.runways.append(Runway(id=1, name='03L-21R', main=RunwayApproach(name='03L', heading=30), opposite=RunwayApproach(name='21R', heading=210)))
        self.runways.append(Runway(id=2, name='03R-21L', main=RunwayApproach(name='03R', heading=30), opposite=RunwayApproach(name='21L', heading=210)))
        self.parking_slots.append(ParkingSlot(
        ...
        self.parking_slots.append(ParkingSlot(
                crossroad_idx=182, position=mapping.Point(-396939.21875, -15793.793945313, self._terrain), large=False, heli=True,
        ...
        self.parking_slots.append(ParkingSlot(
                crossroad_idx=187, position=mapping.Point(-397707.84375, -16375.125976563, self._terrain), large=False, heli=True,
...
class Boulder_City(Airport):
    ...
    def __init__(self, terrain: Terrain) -> None:
        ...
        self.runways.append(Runway(id=1, name='27L-9', main=RunwayApproach(name='27L', heading=270), opposite=RunwayApproach(name='9', heading=90)))
        self.runways.append(Runway(id=1, name='33-15', main=RunwayApproach(name='33', heading=330), opposite=RunwayApproach(name='15', heading=150)))
        self.parking_slots.append(ParkingSlot(
        ...
        self.parking_slots.append(ParkingSlot(
                ...
                airplanes=True, slot_name='C07', length=22.727446, width=18.0, height=6.0, shelter=False))
        self.parking_slots.append(ParkingSlot(
                crossroad_idx=29, position=mapping.Point(-429709.53125, -716.01586914063, self._terrain), large=False, heli=True,
                airplanes=False, slot_name='H07', length=30.096436, width=23.0, height=10.0, shelter=False))
        self.parking_slots.append(ParkingSlot(
...
class Echo_Bay(Airport):
    ...
    def __init__(self, terrain: Terrain) -> None:
        ...
        self.runways.append(Runway(id=1, name='6-24', main=RunwayApproach(name='6', heading=60), opposite=RunwayApproach(name='24', heading=240)))
        self.parking_slots.append(ParkingSlot(
...
class Henderson_Executive(Airport):
    ...
    def __init__(self, terrain: Terrain) -> None:
        ...
        self.runways.append(Runway(id=1, name='35L-17R', main=RunwayApproach(name='35L', heading=350), opposite=RunwayApproach(name='17R', heading=170)))
        self.runways.append(Runway(id=2, name='35R-17L', main=RunwayApproach(name='35R', heading=350), opposite=RunwayApproach(name='17L', heading=170)))
        self.parking_slots.append(ParkingSlot(
...
class Jean(Airport):
    ...
    def __init__(self, terrain: Terrain) -> None:
        ...
        self.runways.append(Runway(id=1, name='20L-2R', main=RunwayApproach(name='20L', heading=200), opposite=RunwayApproach(name='2R', heading=20)))
        self.runways.append(Runway(id=2, name='20R-2L', main=RunwayApproach(name='20R', heading=200), opposite=RunwayApproach(name='2L', heading=20)))
        self.parking_slots.append(ParkingSlot(
...
class Lincoln_County(Airport):
    ...
    def __init__(self, terrain: Terrain) -> None:
        ...
        self.runways.append(Runway(id=1, name='17-35', main=RunwayApproach(name='17', heading=170), opposite=RunwayApproach(name='35', heading=350)))
        self.parking_slots.append(ParkingSlot(
...
class Mesquite(Airport):
    ...
    def __init__(self, terrain: Terrain) -> None:
        ...
        self.runways.append(Runway(id=1, name='1-19', main=RunwayApproach(name='1', heading=10), opposite=RunwayApproach(name='19', heading=190)))
        self.parking_slots.append(ParkingSlot(
...
class Mina(Airport):
    ...
    def __init__(self, terrain: Terrain) -> None:
        ...
        self.runways.append(Runway(id=1, name='13-31', main=RunwayApproach(name='13', heading=130), opposite=RunwayApproach(name='31', heading=310)))
...
class North_Las_Vegas(Airport):
    ...
    def __init__(self, terrain: Terrain) -> None:
        ...
        self.runways.append(Runway(id=2, name='12L-30R', main=RunwayApproach(name='12L', heading=120), opposite=RunwayApproach(name='30R', heading=300)))
        self.runways.append(Runway(id=3, name='25-7', main=RunwayApproach(name='25', heading=250), opposite=RunwayApproach(name='7', heading=70)))
        self.parking_slots.append(ParkingSlot(
...
class Pahute_Mesa(Airport):
    ...
    def __init__(self, terrain: Terrain) -> None:
        ...
        self.runways.append(Runway(id=1, name='36-18', main=RunwayApproach(name='36', heading=360), opposite=RunwayApproach(name='18', heading=180)))
        self.parking_slots.append(ParkingSlot(
...
class Tonopah(Airport):
    ...
    def __init__(self, terrain: Terrain) -> None:
        ...
        self.runways.append(Runway(id=1, name='33-15', main=RunwayApproach(name='33', heading=330), opposite=RunwayApproach(name='15', heading=150)))
        self.runways.append(Runway(id=2, name='29-11', main=RunwayApproach(name='29', heading=290), opposite=RunwayApproach(name='11', heading=110)))
        self.parking_slots.append(ParkingSlot(
