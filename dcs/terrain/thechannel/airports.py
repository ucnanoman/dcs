...
class Abbeville_Drucat(Airport):
    ...
    def __init__(self, terrain: Terrain) -> None:
        ...
        self.runways.append(Runway(id=2, name='27-09', main=RunwayApproach(name='27', heading=270), opposite=RunwayApproach(name='09', heading=90)))
        self.runways.append(Runway(id=1, name='20-02', main=RunwayApproach(name='20', heading=200), opposite=RunwayApproach(name='02', heading=20)))
...
class Merville_Calonne(Airport):
    ...
    def __init__(self, terrain: Terrain) -> None:
        ...
        self.runways.append(Runway(id=2, name='26-08', main=RunwayApproach(name='26', heading=260), opposite=RunwayApproach(name='08', heading=80)))
...
class Dunkirk_Mardyck(Airport):
    ...
    def __init__(self, terrain: Terrain) -> None:
        ...
        self.parking_slots.append(ParkingSlot(
                crossroad_idx=12, position=mapping.Point(15870.676757813, 47370.9140625, self._terrain), large=False, heli=True,
        ...
        self.parking_slots.append(ParkingSlot(
                ...
                airplanes=True, slot_name='17', length=21.0, width=15.0, height=8.0, shelter=False))
        self.parking_slots.append(ParkingSlot(
                crossroad_idx=15, position=mapping.Point(16002.684570313, 47140.2578125, self._terrain), large=False, heli=True,
                airplanes=True, slot_name='18', length=21.0, width=15.0, height=8.0, shelter=False))
        self.parking_slots.append(ParkingSlot(
                crossroad_idx=16, position=mapping.Point(16124.993164063, 47287.0078125, self._terrain), large=False, heli=True,
                airplanes=True, slot_name='14', length=26.0, width=22.0, height=11.0, shelter=False))
        self.parking_slots.append(ParkingSlot(
                crossroad_idx=17, position=mapping.Point(16137.262695313, 46960.53125, self._terrain), large=False, heli=True,
...
class Manston(Airport):
    ...
    def __init__(self, terrain: Terrain) -> None:
        ...
        self.runways.append(Runway(id=3, name='04-23', main=RunwayApproach(name='04', heading=40), opposite=RunwayApproach(name='23', heading=230)))
        self.runways.append(Runway(id=2, name='10-28', main=RunwayApproach(name='10', heading=100), opposite=RunwayApproach(name='28', heading=280)))
        ...
        self.parking_slots.append(ParkingSlot(
                crossroad_idx=19, position=mapping.Point(51907.2421875, -14972.000976563, self._terrain), large=False, heli=True,
        ...
        self.parking_slots.append(ParkingSlot(
                crossroad_idx=57, position=mapping.Point(53171.796875, -15473.270507813, self._terrain), large=False, heli=True,
...
class Hawkinge(Airport):
    ...
    def __init__(self, terrain: Terrain) -> None:
        ...
        self.runways.append(Runway(id=2, name='22-04', main=RunwayApproach(name='22', heading=220), opposite=RunwayApproach(name='04', heading=40)))
...
class Eastchurch(Airport):
    ...
    def __init__(self, terrain: Terrain) -> None:
        ...
        self.runways.append(Runway(id=1, name='02-20', main=RunwayApproach(name='02', heading=20), opposite=RunwayApproach(name='20', heading=200)))
        self.runways.append(Runway(id=2, name='28-10', main=RunwayApproach(name='28', heading=280), opposite=RunwayApproach(name='10', heading=100)))
        self.parking_slots.append(ParkingSlot(
...
class Headcorn(Airport):
    ...
    def __init__(self, terrain: Terrain) -> None:
        ...
        self.runways.append(Runway(id=2, name='01-19', main=RunwayApproach(name='01', heading=10), opposite=RunwayApproach(name='19', heading=190)))
        self.runways.append(Runway(id=1, name='10-29', main=RunwayApproach(name='10', heading=100), opposite=RunwayApproach(name='29', heading=290)))
        self.parking_slots.append(ParkingSlot(
...
class Biggin_Hill(Airport):
    ...
    def __init__(self, terrain: Terrain) -> None:
        ...
        self.runways.append(Runway(id=3, name='30-12', main=RunwayApproach(name='30', heading=300), opposite=RunwayApproach(name='12', heading=120)))
